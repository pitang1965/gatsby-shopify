...
const seller = 'ピータン株式会社'; // 販売業者
const operationManager = 'ピータン'; // 運営責任者
const address = '東京都いなか市 123番地'; // 住所
const tel = '0120-1234-5678'; // 電話番号
const mail = 'info@pitang1965.com'; // メールアドレス
const url = 'https://over40webshop.netlify.app/'; // URL

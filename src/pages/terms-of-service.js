...
const TermsOfService = () => {
  return (
    <Layout>
      ...
      <Title>利用規約</Title>
      <Hedding1>第1条 本規約の適用範囲および変更</Hedding1>
      <p>
        本規約は、{organization}
      ...
      <Hedding1>第2条 本サービスの利用</Hedding1>
      <NumberdList>
        <li>
      ...
      <Hedding1>第4条 本サービスの提供停止、会員登録の抹消</Hedding1>
      <p>
      ...
      <Hedding1>第8条 IDおよびパスワードの管理</Hedding1>
      <NumberdList>
        <li>
      ...
      <Hedding1>第9条 利用者情報(個人情報)</Hedding1>
      <NumberdList>
        <li>
      ...
      <Hedding1>第13条 本サービスの停止</Hedding1>
      <p>
      ...
      <Hedding1>第14条 その他免責事項</Hedding1>
      <NumberdList>
        <li>
      ...
      <Hedding1>第18条 準拠法</Hedding1>
      <p>
        本規約および売買契約の成立、効力、履行および解釈に関しては、日本法が適用されるものとします。
      </p>
      <Hedding1>第19条 管轄裁判所</Hedding1>
      <NumberdList>
        <li>本規約および本サービスに関連して利用者と当社の間で問題が生じた場合には、利用者と当社で誠意を持って協議しこれを解決するものとします。</li>
        <li>前項の規定にもかかわらず、協議しても解決しない場合は、東京地方裁判所を第一審の専属的合意管轄裁判所とします。</li>
      </NumberdList>
    </Layout>
  );
};

...
const RefundPodivcy = () => {
  return (
    <Layout>
      ...
      <Title>返金ポリシー</Title>
      <Hedding1>1. 不具合（事故品）による返品対応</Hedding1>
      <p>
      ...
      <Hedding1>2. お客様のご都合（自己都合）による返品について</Hedding1>
      <p>
      ...
      <Hedding1>3.連絡と返品の方法について</Hedding1>
